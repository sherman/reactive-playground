...
public class ReactiveWsServerApp {
    private static final Logger log = LoggerFactory.getLogger(ReactiveWsServerApp.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            injector.getInstance(ReactiveWsServer.class).start();
        } catch (Exception e) {
